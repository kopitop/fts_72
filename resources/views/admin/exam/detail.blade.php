        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p>{{ $data['exam']->score ? $data['exam']->score : '' }}</p>
                </div>
                    ...
                    {!! Form::open([
                        ...
                        <div class="answer-container">
                            <div class="form-group">
                                <p class="form-control-static">{{ ++$key . '. ' .$question['content']->content }} <span class="btn btn-default">{!! is_null($question['result']->is_correct) ? 'unchecked' : trans('answer.correct.'.$question['result']->is_correct) !!}</span></p>
                                ...
                                @if ($question['content']->type == 3)
                                    <p class="form-control-static"><strong>{{ $question['content']->systemAnswers()->first()->content }}</strong></p>
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::hidden('exam[' . $key . '][result][correct]', config('answer.correct.false')) !!}
                                            {!! Form::checkbox('exam[' . $key . '][result][correct]', config('answer.correct.true'), null, ['class' => 'check-text']) !!}
